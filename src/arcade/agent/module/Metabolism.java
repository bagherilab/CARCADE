...
public abstract class Metabolism implements Module {
	...
	/** Additional energy required during T-cell activation */
	private final double ACTIVE_ENERGY;
	...
	/** {@code true} if T-cell is activated, {@code false} otherwise */
	boolean activeOn;
	...
	Metabolism(Cell c, Simulation sim) {
		...
		this.ACTIVE_ENERGY = series.getParam(pop, "ACTIVE_ENERGY");
