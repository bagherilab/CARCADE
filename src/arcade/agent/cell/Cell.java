...
public interface Cell extends Steppable {
	...
	/** ID for cytotoxic cells */
	int TYPE_CYTOT = 7;
	
	/** ID for stimulatory cells */
	int TYPE_STIMU = 8;
	
	/** ID for exhasuted cells */
	int TYPE_EXHAU = 9;
	
	/** ID for anergic cells */
	int TYPE_ANERG = 10;
	
	/** ID for starved cells */
	int TYPE_STARV = 11;
	...
	/** Code for CAR T-cells 
	 *  Not used in profiler, but used in code.
	 */
	int CODE_T_CELL = 3;
	
	/** Number of different {@link arcade.agent.cell.CARTCell} codes */
	public static final int NUM_TCODES = 2;
	
	/** Code for CD4 CAR T-cells */
	public static final int CODE_4_CELL = 4;
	
	/** Code for CD8 CAR T-cells */
	public static final int CODE_8_CELL = 8;
	...
	/** Flag for cell that is in antigen-induced activation state */
	int IS_ACTIVATED = 4;
	
	/** Flag for cell bound to antigen */
	int IS_BOUNDANTIGEN = 5;
	
	/** Flag for cell bound to self receptor */
	int IS_BOUNDSELFRECEPTOR = 6;
