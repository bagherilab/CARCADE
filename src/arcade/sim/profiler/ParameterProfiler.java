 ...
 *                "pops": [[(pop number),(number of pop seeded)],[(pop number),(number of pop seeded)],..] }
 *        ],
 *        "components": [
 ...
 *                "time": (time),
 *                "cells": [
 *                    [[u,v,w,z],[(cell code id), (cell pop number id), (cell state id), (cell location position), 
 *                        (cell volume), (cell age), [( list, of, cell, parameters, ... )]]],
 *                    [[u,v,w,z],[(cell code id), (cell pop number id), (cell state id), (cell location position),
 *                        (cell volume), (cell age), [( list, of, cell, parameters, ... )]]],
 *                    ...
 *                ]
 ...
 * <pre>
 *    ["NECRO_FRAC", "SENES_FRAC", "ENERGY_THRESHOLD", "MAX_HEIGHT", "ACCURACY",
 *        "AFFINITY", "DEATH_AGE_AVG", "DIVISION_POTENTIAL", "META_PREF",
 *        "MIGRA_THRESHOLD", "CAR_ANTIGENS", "SELF_TARGETS"]
 * </pre>
 * and the list of cell parameters for CAR T-cells is as follows:
 * <pre>
 *    ["SENES_FRAC", "PROLI_FRAC", "EXHAU_FRAC", "ANERG_FRAC", "ENERGY_THRESHOLD",
 *        "ACCURACY", "DEATH_AGE_AVG", "DIVISION_POTENTIAL_T", "META_PREF", 
 *        "META_PREF_IL2", "META_PREF_ACTIVE", "GLUC_UPTAKE_RATE", "GLUC_UPTAKE_RATE_IL2", 
 *        "GLUC_UPTAKE_RATE_ACTIVE", "MAX_ANTIGEN_BINDING", "CARS", "SELF_RECEPTORS", 
 *        "CAR_AFFINITY", "SELF_RECEPTOR_AFFINITY", "SELF_ALPHA", "SELF_BETA", "CONTACT_FRAC"]
 * </pre>
 */
