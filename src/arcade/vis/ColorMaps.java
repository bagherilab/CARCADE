...
class ColorMaps {
	...
	static final Colors MAP_TYPE = new Colors(new Color[] {
		...
		new Color(153,153,255), // cytotoxic
		new Color(102,255,178), // stimulatory
		new Color(188,119,144),	// exhausted
		new Color(255,153,255), // anergic
		new Color(250,179,150), // starved
		new Color(173,192,226)  // paused
	});
	...
	/** Color map for IL-2 concentration */
	final Colors MAP_IL2;
	...
	ColorMaps(Series series) {
		...
		MAP_IL2 = new Colors(new Color[] {
				new Color(204,255,229),
				new Color(102,255,178),
				new Color(0,255,102),
				new Color(0,102,51),
				new Color(0,0,0)
		}, new double[] { 0, 1E3, 1E6, 1E9, 1E12});
		...
		double maxAgents = 54.0;
		String coord = series.getCoordString();
		if(coord == "RECT") {  maxAgents = 64.0; }
		MAP_COUNT = new Colors(new Color[] {
				new Color(0,0,0,0),
				...
				new Color(215,48,31),
				new Color(153,0,0)
		}, new double[] { 0, (1.0/6.0)*maxAgents, (2.0/6.0)*maxAgents, (3.0/6.0)*maxAgents,
				(4.0/6.0)*maxAgents, (5.0/6.0)*maxAgents, maxAgents });
